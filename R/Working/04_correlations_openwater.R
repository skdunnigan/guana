...
ggcorrplot(corr,
  ...
  labs(title = 'Correlation Plot 1, open water sites',
       caption = 'Spearman Rank correlations, complete obs',
       subtitle = 'basic')
ggsave("output/correlations/openwater_1.png", width = 7.5, height = 7.5, dpi = 300)
...
ggcorrplot(corr, p.mat = p.mat,
  ...
  theme(# everything in theme is strictly aesthetics
    ...
    plot.title = element_text(size = 16, face='bold'),
    plot.subtitle = element_text(size = 11, face = 'italic')) +
  labs(title = 'Correlation Plot 2, open water sites',
       caption = 'Spearman Rank correlations, complete obs',
       subtitle = 'insignificant correlations removed')
ggsave("output/correlations/openwater_2.png", width = 7.5, height = 7.5, dpi = 300)
...
ggcorrplot(corr, p.mat = p.mat,
  ...
  theme(# everything in theme is strictly aesthetics
    ...
    plot.title = element_text(size = 16, face='bold'),
    plot.subtitle = element_text(size = 11, face = 'italic')) +
  labs(title = 'Correlation Plot 3, open water sites',
       caption = 'Spearman Rank correlations, complete obs',
       subtitle = 'insignificant correlations removed and correlation coefficients')
ggsave("output/correlations/openwater_3.png", width = 8, height = 8, dpi = 300)
