...
```{r salinityplot, echo = FALSE, fig.width = 7, fig.cap = "Figure 2: Salinity (psu) measured at each sampling station on the day of water sample collections. Black line represents data collected at "}
dat4 %>%
  ...
  geom_line(data = swmp_dat_w, aes(x = date_sampled, y = salt_n), color = "black", size = 1) +
  geom_point(data = swmp_dat_w, aes(x = date_sampled, y = salt_n), color = "black", size = 3) +
